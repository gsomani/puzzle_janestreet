module counter_control1 (
    ...
    assign a22o_2_21_B2 = ~((or2_2_8_X &(counter_output[1:0] == 1)) | (counter_output[2] ? counter_output[3] : counter_output[1]));  // a21oi_2_15 : a21oi_2
    ...
    assign and2b_2_19_X = (~or2_2_8_X)
                          &(counter_output[1:0] != 2);  // and2b_2_19 : and2b_2
    ...
    assign inv_2_12_A = ~(counter_output[2] &(counter_output[1:0] == 2));  // nand2_2_32 : nand2_2
    ...
    assign o22a_2_2_X = (counter_output[3] | (counter_output[1:0] != 3))
                        & ((counter_output[3:2] != 3) |(counter_output[1:0] == 0));  // o22a_2_2 : o22a_2
    assign o31a_2_0_A2 = ~((nor3_2_1_C & o32ai_2_0_B1 &(counter_output[3:2] != 1)) | and3b_2_0_C);  // a31oi_2_0 : a31oi_2
    ...
    assign o32a_2_2_B1 = (~or3_2_9_B)
                         &(counter_output[1:0] != 3);  // and2b_2_15 : and2b_2
    ...
    assign a31o_2_15_X = (counter_output[2] & inv_2_14_Y &(counter_output[1:0] != 3))
                         | (~((counter_output[0] & inv_2_14_Y) | (or2_2_9_X &(counter_output[1:0] != 3))));  // a31o_2_15 : a31o_2
    ...
    assign o221a_2_2_X = (or2_2_8_X |(counter_output[1:0] == 1))
                         ...
                         &(counter_output[1:0] != 2);  // o221a_2_2 : o221a_2
    assign o31a_2_0_X = (o31a_2_0_A1 | o31a_2_0_A2 | (~(counter_output[2] |(counter_output[1:0] == 0) |(counter_output[1:0] == 3))))
                        & ((nor3_2_1_C & o32ai_2_0_B1 &(counter_output[3:2] != 1))
                         | ((~counter_output[2])
                         & counter_output[0])
    ...
    assign o21ai_2_4_Y = ~((inv_2_12_Y | o32a_2_2_B2) & ((counter_output[0] & counter_output[2])
                         | inv_2_14_Y
                         |(counter_output[1:0] == 2)));  // o21ai_2_4 : o21ai_2
